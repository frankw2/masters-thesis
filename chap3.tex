...
%Functional encryption is even slower because
%the garbled circuits protocol provides ``hints''
%during decryption through its interactive protocol
%that do not exist in functional encryption.
