...
% Sieve is a novel system that provides both
% user-controlled storage and rich server-side 
% computation for web applications.
% To the best of our knowledge,
% it is the first system to provide provably secure
% access control, strong revocation semantics,
% and distributed trust that is compatible with
% widely deployed web application software stacks.
